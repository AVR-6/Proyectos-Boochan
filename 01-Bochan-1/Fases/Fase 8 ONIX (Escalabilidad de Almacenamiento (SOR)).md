...
- **Creación del VDI:** En VirtualBox, añadimos un disco nuevo de **100 GB** (SATA).
    
- **Carga de ISO:** En `Almacenamiento`, insertamos la ISO de **gparted-live-xxx.iso** en la unidad óptica virtual.
    
- **Arranque:** Iniciamos la VM y pulsamos `F12` (o configuramos el orden de arranque) para iniciar desde el CD.
...
- **Nueva Partición:** Clic derecho en el espacio gris -> `New`.
    
    - **Filesystem:** `ext4`.
        
    - **Label:** `BACKUPS`.
        
- **Aplicar:** Clic en el botón de la "V" (Apply) para confirmar los cambios.
